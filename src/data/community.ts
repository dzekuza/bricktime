...
export const leaderboard: LeaderboardEntry[] = [
  {
    ...
    userId: "u1",
    name: "Lukas M.",
    avatarSrc: "/avatars/avatar-robot.png",
    avatarBg: "#4DA2FF",
    tier: "Mega",
    tierBg: "#FB4903",
    totalPoints: 485,
  ...
  },
  {
    ...
    userId: "u2",
    name: "Gabija K.",
    avatarSrc: "/avatars/avatar-wizard.png",
    avatarBg: "#5C4ADE",
    tier: "Pro",
    tierBg: "#4DA2FF",
    totalPoints: 360,
  ...
  },
  {
    ...
    userId: "u3",
    name: "Tomas R.",
    avatarSrc: "/avatars/avatar-ninja.png",
    avatarBg: "#001B21",
    tier: "Pro",
    tierBg: "#4DA2FF",
    totalPoints: 295,
  ...
  },
  {
    ...
    userId: "u4",
    name: "Rūta S.",
    avatarSrc: "/avatars/avatar-beanie.png",
    avatarBg: "#FB4903",
    tier: "Standard",
    tierBg: "#FFD731",
    totalPoints: 230,
  ...
  },
  {
    ...
    userId: "current",
    name: "Alex Kim",
    avatarSrc: "/avatars/avatar-classic.png",
    avatarBg: "#FFD731",
    tier: "Standard",
    tierBg: "#FFD731",
    totalPoints: 195,
...
export const feedItems: FeedItem[] = [
  ...
  },
  {
    ...
    avatarBg: "#FB4903",
    type: "first_drop",
    timestamp: "2026-04-29T18:22:00Z",
    dropNum: 25,
    dropTitle: "The Greenhouse",
    likeCount: 7,
    likedByCurrentUser: false,
  },
  {
    ...
    avatarBg: "#4DA2FF",
    type: "streak",
    timestamp: "2026-04-29T09:01:00Z",
    body: "7",
    likeCount: 5,
    likedByCurrentUser: false,
  },
