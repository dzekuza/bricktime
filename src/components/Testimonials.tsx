    ...
    <section ref={containerRef} className="bg-paper py-10 md:py-20">
      <div className="mx-auto max-w-[1320px] px-4 md:px-7">
        <div ref={ref} className="grid grid-cols-1 gap-4 lg:grid-cols-12">
          ...
          <div
            className={[
              "reveal brick-card brick-card-hover flex min-h-[280px] flex-col justify-between p-6 md:p-9",
          ...
          >
            ...
            <p className="heading-display text-d-xs mt-4 leading-[1.05] text-ink uppercase">
          ...
          <div
            className={[
              "reveal brick-card brick-card-hover flex min-h-[280px] flex-col justify-between p-6 md:p-8",
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <div>
                ...
                <small className="mt-0.5 block font-mono text-[10px] tracking-[.12em] text-ink/55 uppercase">
                  {testimonials[1].meta}
                </small>
              </div>
            </div>
          ...
          <div
            className="reveal flex min-h-[220px] flex-col justify-center rounded-2xl border-2 border-ink p-6 shadow-[6px_6px_0_rgba(245,241,235,.12)] md:rounded-3xl md:p-9 lg:col-span-5"
            style={{ background: "#001B21", transitionDelay: "80ms" }}
          >
            <h3 className="label-mono text-paper/50">⬢ Prenumeratoriai</h3>
            <h2 className="heading-display text-d-lg mt-3 text-paper">
              <span
          ...
          <div
            className={[
              "reveal brick-card brick-card-hover flex min-h-[220px] flex-col justify-between p-6 md:p-8",
