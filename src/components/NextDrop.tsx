      ...
      <div className="relative overflow-hidden bg-brand-mint rounded-3xl px-8 md:px-12 py-10">
        ...
        {released ? (
          <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
            ...
            <a
              href="/archive"
              className="label-mono text-brand-orange underline underline-offset-4"
            >
              Peržiūrėti katalogą →
            </a>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-6 md:gap-12">
            <h2 className="heading-display text-d-md text-ink shrink-0">
              Naujas rinkinys<br />
              <span className="text-brand-orange">netrukus.</span>
            </h2>
            ...
            {earlyAccessGranted && (
              <div className="shrink-0">
                <span className="label-mono bg-brand-orange text-ink px-3 py-1.5 rounded-lg">
                  Early Access aktyvus
                </span>
              </div>
            )}
            {inEarlyWindow && !earlyAccessGranted && earlyTierNames && (
              <p className="label-mono text-ink/50 shrink-0 md:max-w-[200px]">
