  ...
  return (
    <section className="relative overflow-hidden bg-paper">
      ...
      <div className="relative">
        <div className="relative z-10 mx-auto max-w-[1320px] px-4 pt-10 pb-10 text-center md:px-7 md:pt-14">
          ...
          <h1 className="heading-display text-d-hero tracking-[-0.02em] text-ink">
            ...
            <br />
            <span className="inline-block skew-x-[-8deg] italic">
              Suaugusiems
            </span>
          </h1>
          ...
          <p className="mx-auto mt-7 max-w-[52ch] text-[17px] leading-[1.65] text-ink/65">
            Nuomokis išskirtinius rinkinius su mėnesine prenumerata. Pasirink
            planą, išsirink norimą rinkinį, gauk jį į namus ar paštomatą, surink
            ir keisk į naują kada panorėjęs.
          </p>
      ...
      <div className="mx-auto max-w-[1320px] px-4 pb-16 md:px-7">
        <div className="aspect-[4/3] w-full overflow-hidden rounded-[28px] border-2 border-ink shadow-[6px_6px_0_#001B21] md:aspect-[16/7] md:rounded-3xl">
          <video
