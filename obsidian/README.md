...
# 🧠 bricks — Project Brain

This vault is the **single source of truth** for `bricks`. It documents how the
...
> <!-- One paragraph: what bricks is, who it is for, what stage it is at. -->
